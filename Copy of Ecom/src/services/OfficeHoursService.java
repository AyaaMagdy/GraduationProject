...
public class OfficeHoursService extends  AsyncTask<String,Void,String>  {

	String serviceType;
	Context ctx;
	public OfficeHoursService (Context ctx)
	{
	   this.ctx=ctx; 	
	}
	@Override
	protected String doInBackground(String... params) {
		String response = "";
		 try {
			...
			if (serviceType.equals("getOfficeHours"))
			{
