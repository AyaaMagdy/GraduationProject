...
public class attendanceService  extends AsyncTask<String,Void,String> {
	Context ctx;
	 attendanceService()  
	   {  
	 ...
	 public attendanceService(Context ctx)  
	   {  
	    this.ctx =ctx;  
	   }  
	...
	protected String doInBackground(String... params) {
		...
		try {
           ...
           while((line = buffer.readLine())!=null){
			...
			else if(method.equals("CourseName")){
				DefaultHttpClient client = new DefaultHttpClient();
	           ...
	           while((line = buffer.readLine())!=null){
			...
			else if(method.equals("labAttendance")){
				DefaultHttpClient client = new DefaultHttpClient();
		        ...
		        param.add(new BasicNameValuePair("year",params[4]));
			...
			else if(method.equals("sectionAttendance")){
				DefaultHttpClient client = new DefaultHttpClient();
