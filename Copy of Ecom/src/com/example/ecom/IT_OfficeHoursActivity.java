...
public class IT_OfficeHoursActivity extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_it_office_hours_activty);
		OfficeHoursContoller officeHourseObject= new OfficeHoursContoller();
		OfficeHoursModel officeHours = new OfficeHoursModel();
	
		try{
	    ArrayList<OfficeHoursModel> officeHoursList= officeHourseObject.getOfficeHours("IT",this);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.is__office_hours_activty, menu);
		return true;
	}
