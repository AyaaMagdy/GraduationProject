...
public class DS_OfficeHoursActivity extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_ds_office_hours);
		OfficeHoursContoller officeHourseObject= new OfficeHoursContoller();
		OfficeHoursModel officeHours = new OfficeHoursModel();
	
		try{
	    ArrayList<OfficeHoursModel> officeHoursList= officeHourseObject.getOfficeHours("DS",this);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.ds__office_hours, menu);
		return true;
	}
