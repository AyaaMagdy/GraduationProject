...
public class IS_OfficeHoursActivity extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_is_office_hours);
		OfficeHoursContoller officeHourseObject= new OfficeHoursContoller();
		OfficeHoursModel officeHours = new OfficeHoursModel();
	
		try{
	    ArrayList<OfficeHoursModel> officeHoursList= officeHourseObject.getOfficeHours("IS",this);
