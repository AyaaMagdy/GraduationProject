...
public class TableController 
{
	...
	public ArrayList<TableModel> getTable(ArrayList<String>coursesAndGroups,Context ctx,String url,String method) throws InterruptedException, ExecutionException
	{
		  ...
		  {
			  TableService c=new TableService(ctx);
		  c.execute(url,coursesAndGroups.get(i),coursesAndGroups.get(i+1),method);
		  String result = c.get();
